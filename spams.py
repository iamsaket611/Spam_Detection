...
data1 = data1.append(dffromdirectory(r'E:\AI ineuron\Natural Processing Language\Projects\spam\emails\spam', 'spam'))
data1 = data1.append(dffromdirectory(r'E:\AI ineuron\Natural Processing Language\Projects\spam\emails\ham', 'ham'))
